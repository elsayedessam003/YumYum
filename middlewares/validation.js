...
exports.validateRestaurant = [
  ...
  body("estimatedDeliveryTime").isFloat({min:0}).withMessage('Estimated delivery time must be positive integar'),
  body("cuisines").isArray().withMessage('Cuisines must be array').notEmpty().withMessage('Cuisines array cannot be empty'),
