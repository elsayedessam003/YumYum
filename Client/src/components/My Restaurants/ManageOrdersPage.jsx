...
<div className="relative">
  <div className="flex space-x-4 relative pb-2">
    ...
    <span className={`absolute bottom-0 left-0 h-1 bg-project-orange transition-transform duration-300 ease-in-out`}
      style={{
  ...
  <div className="mt-4">
    ...
    <ManageOrderCard key={order.orderId} order={order} onReadyForDelivery={handleReadyForDelivery} />
    ))
    ) : (
