...
const Sidebar = ({ setActiveSection, userName = "Elsayed" }) => {
    ...
    return (
    <div className="w-1/8 h-3/4 border-r p-6">
        ...
        <div
            ...
            activeSection === "accountInfo" ? "text-project-orange" : "text-gray-400"
            }`}
        ...
        <div
            className={`w-[229px] h-[52px] cursor-pointer text-lg font-semibold flex items-center p-3 rounded-lg ${
            activeSection === "myOrders" ? "text-project-orange" : "text-gray-400"
            }`}
        ...
        <div
            className={`w-[229px] h-[52px] cursor-pointer text-lg font-semibold flex items-center p-3 rounded-lg ${
            activeSection === "myRestaurants" ? "text-project-orange" : "text-gray-400"
            }`}
